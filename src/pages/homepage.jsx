...
const Home = () => {
  ...
  return (
    <>
            ...
            <div className='flex gap-7 mt-14'>
              {
                statistic.map((item, index) => (
                  <Card align="center" key={index} className='max-w-[8rem] bg-smoothSecondary'>
                    <CardTitle className="text-black" size='text-3xl'>{item.value}</CardTitle>
      ...
      <Section>
        <Heading className="w-[45%] my-auto mr-20 py-10 bg-no-repeat bg-[url('https://www.kotakode.com/static/media/greenDot.7e463379.svg')]">
        ...
        <div className='flex flex-col gap-10 p-5'>
          <Card className={`${flexCenter} w-[53%] gap-5 py-5 self-end full-shadow`}>
          ...
          <Card className={`${flexCenter} w-[53%] gap-5 py-5 self-center full-shadow`}>
