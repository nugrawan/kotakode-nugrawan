// Suggested code may be subject to a license. Learn more: ~LicenseLog:4218055082.
...
const Footer = () => {
  return (
    <div className="bg-[#1f2329] px-20 text-[#b2b9bf] p-5 pt-16 font-quicksand font-bold">
